            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.meta.code == 200) {
                        if (userId.length == 8) {
                            window.location.href = "student-index.html?id=" + userId + "&session=" + data.data.session;
                        }
                        else {
                            window.location.href = "teacher-index.html?id=" + userId + "&session=" + data.data.session;
                        }
                    }
                },
                error: function (data) {
